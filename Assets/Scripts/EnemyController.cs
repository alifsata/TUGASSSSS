...
{
    public bool isGrounded = false; // untuk mengecek karakter berada di
...
public bool isFacingRight = false;
 ...
 else if (transform.position.x <= batas1.position.x && !
isFacingRight)
                Flip();
        }
    }
    ...
    //digunakan untuk mengecek apakah Player masih diatas tanah ata
 ...
 void OnCollisionStay2D(Collision2D col)
    ...
    //digunakan untuk memberi tahu Player bahwa sudah tidak diatas
